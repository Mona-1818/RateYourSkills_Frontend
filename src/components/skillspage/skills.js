                    ...
                    <div className='right-section'>
                        <div className='titleStickyHeader'>
                            ...
                            <div className='titleContainer'>
                                <div className='bar_items' style={{ width: 107.783 }}> Skills required </div>
                                <div className='bar_items' style={{ width: 105.367 }}> Test structure </div>
                                <div className='bar_items' style={{ width: 100.817 }}> Downloads </div>
                                <div className='bar_items' style={{ width: 83.6 }}> FAQs </div>
                                {/* <div className='bar_items' style={{ width: 142.4 }}> </div> */}
                                {/* <div className='bar_items' style={{ width: 39.65 }}>  </div> */}
                            </div>
